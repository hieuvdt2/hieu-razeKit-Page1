            ...
            <Row>
              ...
              <Col xs={24} xl={14} xxl={16}>
                <div className="world-new">
                  <img src={process.env.PUBLIC_URL + "img/new-more.png"} className="world__img" />
            ...
            <div className="container">
              ...
              <Row style={{ margin: "0 -20px" }}>
                <Col sm={24} md={12} lg={8}>
                  <div className="col-trending">
                    <div className="img-content">
                      <img src={process.env.PUBLIC_URL + "/img/one.png"} />
                    </div>
                ...
                <Col sm={24} md={12} lg={8}>
                  ...
                  <div className="col-trending">
                    <div className="img-content">
                      <img src={process.env.PUBLIC_URL + "/img/annie.png"} />
                    </div>
                    <div className="text-content">
                      <h3 className="text-content__title">
                ...
                <Col sm={0} md={0} lg={8}>
                  ...
                  <div className="col-trending">
                    <div className="img-content">
                      <img src={process.env.PUBLIC_URL + "/img/carlos.png"} />
                    </div>
                    <div className="text-content">
                      <h3 className="text-content__title">
                        Morbi eleifend a libero
              ...
              <Row gutter={[20, 0]}>
                <Col xs={24} xl={16} xxl={16}>
                  ...
                  <div className="img-city">
                    <img src={process.env.PUBLIC_URL + "/img/image.png"} />
                  ...
                  <Row gutter={[38, 0]}>
                    <Col xs={24} xl={24}>
                      ...
                      <div className="happending-ringht">
                        <img src={process.env.PUBLIC_URL + "/img/gau.png"} />
